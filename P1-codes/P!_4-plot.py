...
ax1.scatter(x_start, y_start, color='steelblue', alpha=0.7, s=20, edgecolor='black', linewidth=0.5)
ax1.set_xlabel('$x$ ', fontsize=13, fontweight='bold')
ax1.set_ylabel('$y$ ', fontsize=13, fontweight='bold')
ax1.set_title('Starting Positions', fontsize=15, fontweight='bold', pad=15)
ax1.grid(True, alpha=0.3, linestyle='--')
ax1.set_aspect('equal', adjustable='box')
# Plot ending positions
ax2.scatter(x_end, y_end, color='coral', alpha=0.7, s=20, edgecolor='black', linewidth=0.5)
ax2.set_xlabel('$x$ ', fontsize=13, fontweight='bold')
ax2.set_ylabel('$y$ ', fontsize=13, fontweight='bold')
ax2.set_title('Ending Positions', fontsize=15, fontweight='bold', pad=15)
